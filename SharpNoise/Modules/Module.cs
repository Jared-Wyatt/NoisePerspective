...
namespace SharpNoise.Modules
{
    ...
    public abstract class Module
    {
        ...
        public delegate double GetValueDelegate(double x, double y, double z);
        ...
        //Used to set source Modules from generator
        public virtual void SetSourceModules(Module[] sourceModules)
        {
