...
namespace NoisePerspective
{
    namespace Noise
    {
        public class RidgedMultifractal : Noise
        {
            public SharpNoise.Modules.RidgedMulti outputModule = new SharpNoise.Modules.RidgedMulti();

            public RidgedMultifractal(Scene scene, Vector2 position) : base(scene, position)
            {
            ...
            public override void DrawWindow()
            {
                ...
                using (var fadeScope = new EditorGUILayout.FadeGroupScope(fadeGroupValue))
                {
                    ...
                    {
                        //Octave
                        using (var OctaveContainerContainer = new EditorGUILayout.VerticalScope("box"))
                        {
                    ...
                    {
                        //Lacunarity
                        using (var LacunarityContainer = new EditorGUILayout.VerticalScope("box"))
                        {
